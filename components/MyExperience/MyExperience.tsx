                            ...
                            <motion.li
                                ...
                                <div className="w-full flex justify-between flex-none items-center h-min flex-nowrap overflow-visible p-0 relative">
                                    <div className="flex items-center flex-1 gap-2 h-min justify-start overflow-visible p-0 relative ">
                                        <div className="bg-dark-gray-4 border border-border-color rounded-lg flex float-none gap-[10px] h-min justify-center items-center overflow-visible p-[12px] relative w-min ">
                                            <div className="flex-none aspect-square h-auto overflow-visible relative w-[36px] ">
                                                <figure className='block absolute inset-0'>
                                                    <Image 
                                                        ...
                                                        quality={100}
                                                        priority={index < 2}
                                                        unoptimized={typeof exp.logo === 'string' && exp.logo.endsWith('.svg')}
                                                    />
                                                </figure>
                                            </div>
                                        </div>
