    ...
    return (
        ...
        >
            <div className="flex items-end justify-between h-full flex-none flex-nowrap relative p-[20px_30px_40px_0px] flex-col">
                ...
                >
                    <div className="w-[50px] aspect-square h-auto rounded-full flex-none relative bg-darkest-gray flex items-center justify-center">
                        <Home size={24} className="text-light-gray-3" />
                    </div>
                </Link>
                {/* middle */}
                <motion.ul
